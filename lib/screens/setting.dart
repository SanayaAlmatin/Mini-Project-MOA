...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  void _logout() {
    // Lakukan proses logout seperti menghapus token yang disimpan
    // Misalnya, Anda dapat menggunakan SharedPreferences untuk menyimpan token dan menghapusnya saat logout
